...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-07-2023 a las 18:43:13
...
(4, 'carlos', 'rodriguez', 'ramos', '3154215897', 'rudolfg@hotmail.com', 'la huertona', 'vespertino', '1234', 'administrador'),
...
--
ALTER TABLE `reservaciones`
  MODIFY `idReservaciones` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;
